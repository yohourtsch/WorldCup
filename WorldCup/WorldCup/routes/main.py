...
MARKETS = {
    "correct-score": {
        ...
        "placeholder": "0:0",
        "lottery_odds_placeholder": "8.500",
        "foreign_odds_placeholder": "8.100",
        "path": "/",
        "endpoint": "main.index",
    },
    "half-full": {
        ...
        "placeholder": "胜胜",
        "lottery_odds_placeholder": "3.200",
        "foreign_odds_placeholder": "3.100",
        "path": "/half-full",
    ...
    "total-goals": {
        ...
        "placeholder": "1球",
        "lottery_odds_placeholder": "4.500",
        "foreign_odds_placeholder": "4.300",
        "path": "/total-goals",
    ...
    "match-result": {
        ...
        "placeholder": "胜",
        "lottery_odds_placeholder": "2.100",
        "foreign_odds_placeholder": "2.050",
        "path": "/match-result",
...
def _market_page(market):
    ...
    try:
        ...
        if market["key"] == "correct-score":
            ev_threshold_value = "all"
            ev_threshold = None
            sort_by = "market_order"
        else:
